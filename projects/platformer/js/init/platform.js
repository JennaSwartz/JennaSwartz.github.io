(function (window) {
    ...
    platform.init = function (game) {
        ...
        // example:
        platform.create(100, 560, 0.9, 0.6);
        platform.create(600, 260, 0.9, 0.6);
        platform.create(80, 390, 0.6, 0.6);
        platform.create(450, 475, 0.6, 0.7);
        platform.create(420, 320, 0.5, 0.9);
